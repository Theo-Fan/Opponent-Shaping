...
class CoinGame:
    ...
    def step(self, actions):
        ...
        new_rng, coin_position_rng, coin_owner_rng = rax.split(self.rng, 3)
        new_coin_pos = self._random_coin_position(coin_position_rng, new_players_pos, self.HEIGHT, self.WIDTH)
        new_coin_owner = rax.randint(coin_owner_rng, minval=0, maxval=self.NUM_PLAYERS, shape=[])
...
def eval_agent_against_always_cooperate(state, hp, jit_episode_stats, player):
    ...
    wandb.log({f'agent{player}/eval_always_cooperate_mean_rewards_self': stats["mean_rewards"][agent_player],
               f'agent{player}/eval_always_cooperate_mean_rewards_opponent': stats["mean_rewards"][other_player],
               f'agent{player}/eval_always_cooperate_adversity_self': stats["adversity"][agent_player],
               f'agent{player}/eval_always_cooperate_adversity_opponent': stats["adversity"][other_player],
               f'agent{player}/eval_always_cooperate_easymisses_self': stats["easymisses"][agent_player],
               f'agent{player}/eval_always_cooperate_easymisses_opponent': stats["easymisses"][other_player],
               f'agent{player}/eval_always_cooperate_adversarial_pickup_div_timesteps_self': stats["adversarial_pickup_div_timesteps"][agent_player],
               f'agent{player}/eval_always_cooperate_adversarial_pickup_div_timesteps_opponent': stats["adversarial_pickup_div_timesteps"][other_player],
               f'agent{player}/eval_always_cooperate_any_pickup_div_timesteps_self': stats["any_pickup_div_timesteps"][agent_player],
               f'agent{player}/eval_always_cooperate_any_pickup_div_timesteps_opponent': stats["any_pickup_div_timesteps"][other_player],
               f'agent{player}/eval_always_cooperate_adversarial_pickup_div_all_pickup_self': stats["adversarial_pickup_div_all_pickup"][agent_player],
               f'agent{player}/eval_always_cooperate_adversarial_pickup_div_all_pickup_opponent': stats["adversarial_pickup_div_all_pickup"][other_player],
               f'agent{player}/eval_always_cooperate_nearpasses_self': stats["nearpasses"][agent_player],
               f'agent{player}/eval_always_cooperate_nearpasses_opponent': stats["nearpasses"][other_player],
               f'agent{player}/eval_always_cooperate_own_pickup_div_timesteps_self': stats["own_pickup_div_timesteps"][agent_player],
               f'agent{player}/eval_always_cooperate_own_pickup_div_timesteps_opponent': stats["own_pickup_div_timesteps"][other_player],
               },
              step=state['step'])
...
def eval_agent_against_always_defect(state, hp, jit_episode_stats, player):
    ...
    wandb.log({f'agent{player}/eval_always_defect_mean_rewards_self': stats["mean_rewards"][agent_player],
               f'agent{player}/eval_always_defect_mean_rewards_opponent': stats["mean_rewards"][other_player],
               f'agent{player}/eval_always_defect_adversity_self': stats["adversity"][agent_player],
               f'agent{player}/eval_always_defect_adversity_opponent': stats["adversity"][other_player],
               f'agent{player}/eval_always_defect_easymisses_self': stats["easymisses"][agent_player],
               f'agent{player}/eval_always_defect_easymisses_opponent': stats["easymisses"][other_player],
               f'agent{player}/eval_always_defect_adversarial_pickup_div_timesteps_self': stats["adversarial_pickup_div_timesteps"][agent_player],
               f'agent{player}/eval_always_defect_adversarial_pickup_div_timesteps_opponent': stats["adversarial_pickup_div_timesteps"][other_player],
               f'agent{player}/eval_always_defect_any_pickup_div_timesteps_self': stats["any_pickup_div_timesteps"][agent_player],
               f'agent{player}/eval_always_defect_any_pickup_div_timesteps_opponent': stats["any_pickup_div_timesteps"][other_player],
               f'agent{player}/eval_always_defect_adversarial_pickup_div_all_pickup_self': stats["adversarial_pickup_div_all_pickup"][agent_player],
               f'agent{player}/eval_always_defect_adversarial_pickup_div_all_pickup_opponent': stats["adversarial_pickup_div_all_pickup"][other_player],
               f'agent{player}/eval_always_defect_nearpasses_self': stats["nearpasses"][agent_player],
               f'agent{player}/eval_always_defect_nearpasses_opponent': stats["nearpasses"][other_player],
               f'agent{player}/eval_always_defect_own_pickup_div_timesteps_self': stats["own_pickup_div_timesteps"][agent_player],
               f'agent{player}/eval_always_defect_own_pickup_div_timesteps_opponent': stats["own_pickup_div_timesteps"][other_player],
               },
              step=state['step'])
